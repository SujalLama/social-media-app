...
export default function Comments (props) {
  ...
  const deleteComment = comment => event => {
    ...
    return (<div>
        <CardHeader
              avatar={
                <Avatar className={classes.smallAvatar} src={PHOTO_URL+auth.isAuthenticated().user.photo}/>
              }
              title={ <TextField
        ...
        { props.comments.map((item, i) => {
            return <CardHeader
                      avatar={
                        <Avatar className={classes.smallAvatar} src={PHOTO_URL+item.postedBy.photo}/>
                      }
